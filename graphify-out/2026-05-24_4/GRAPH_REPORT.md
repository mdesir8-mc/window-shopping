...
## Corpus Check
- 95 files · ~42,889 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1915 nodes · 4996 edges · 131 communities (96 shown, 35 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 124 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b6725f56`
...
Cohesion: 0.16
Nodes (14): color, counts, name, request, router, request, router, AuthenticatedRequest (+6 more)

### Community 2 - "Bundled JS (Query/State)"
Cohesion: 0.11
Nodes (28): b0, Bh(), c0(), dh(), E0(), g0(), gi(), hh() (+20 more)

### Community 3 - "Bundled JS (Observer)"
Cohesion: 0.19
Nodes (16): addObserver(), cancel(), clearGcTimeout(), clearTimeout(), destroy(), getMutationCache(), ja(), mutate() (+8 more)

### Community 4 - "Bundled JS (Utilities)"
Cohesion: 0.08
Nodes (47): Wr(), An(), Cl(), Cu(), eh(), En(), Ep(), eu() (+39 more)
...
Cohesion: 0.08
Nodes (50): at, ax(), b1(), bx(), Ce(), cx(), dx(), ei() (+42 more)
...
Cohesion: 0.15
Nodes (13): useClosets(), useCreateItem(), useParseUrl(), AddItemFlow(), Step, AppShell(), AppShellContext, AppShellContextValue (+5 more)

### Community 11 - "Auth API Layer"
Cohesion: 0.11
Nodes (25): getCurrentUser(), login(), register(), Request Auth Interceptor, Response 401 Interceptor, App Component (Router Root), AuthBootstrap Component, ProtectedRoute Component (+17 more)
...
Cohesion: 0.11
Nodes (18): ClosetCard(), ClosetCardProps, ClosetGridProps, ItemCard(), ItemGrid(), SidebarProps, hashTone(), ParsedProduct (+10 more)

### Community 15 - "Bundled JS (DOM)"
Cohesion: 0.07
Nodes (38): ad(), add(), ai(), cd(), da(), dt(), ey(), Ga() (+30 more)
...
Cohesion: 0.08
Nodes (49): bg(), Bl(), bo(), bu(), Cg(), eg(), fh(), gf() (+41 more)
...
Cohesion: 0.33
Nodes (6): el(), jw, Lm(), [Symbol.iterator](), toJSON(), toString()
...
Cohesion: 0.20
Nodes (19): apiClient, createCloset(), createSection(), deleteCloset(), deleteSection(), getCloset(), listClosets(), patchCloset() (+11 more)

### Community 22 - "Bundled JS (Base)"
Cohesion: 0.06
Nodes (75): Ae(), bg(), bo(), Bt(), bu(), bx(), cd(), Cg() (+67 more)

### Community 23 - "Bundled JS (Misc)"
Cohesion: 0.07
Nodes (43): add(), build(), Cn(), defaultMutationOptions(), defaultQueryOptions(), dm(), ensureInfiniteQueryData(), ensureQueryData() (+35 more)

### Community 24 - "Bundled JS (Array Util)"
Cohesion: 0.21
Nodes (11): a0, a1(), concat(), getMutationDefaults(), hm(), kh(), Qa(), request() (+3 more)

### Community 25 - "Bundled JS (Options)"
Cohesion: 0.31
Nodes (13): build(), Cn(), defaultQueryOptions(), ensureQueryData(), fetch(), fetchOptimistic(), fetchQuery(), getQueryDefaults() (+5 more)
...
Cohesion: 0.39
Nodes (9): useCreateSection(), useDeleteSection(), usePatchSection(), useItems(), useAppShell(), formatCompactCurrency(), parsePriceToNumber(), ClosetDetail() (+1 more)
...
Cohesion: 0.25
Nodes (8): Gr, Ha(), ls(), Pw(), Us(), xh(), yw(), zh()

### Community 30 - "Bundled JS (Events)"
Cohesion: 0.07
Nodes (41): Ac(), Af(), Ap(), ar(), Bf(), bp(), ct(), Dn() (+33 more)
...
Cohesion: 0.09
Nodes (27): _1(), canRun(), continue(), Cy(), dd(), delete(), Et(), execute() (+19 more)

### Community 33 - "Bundled JS (Iterator)"
Cohesion: 0.33
Nodes (6): Fl(), from(), Jd(), normalize(), Ol(), om()
...
Cohesion: 0.07
Nodes (55): Ag(), ay(), bc(), be(), ch(), cp(), cr, d0() (+47 more)

### Community 36 - "Bundled JS (Selector)"
Cohesion: 0.06
Nodes (48): _(), accessor(), ah(), am(), B(), b0(), b1(), bindMethods() (+40 more)
...
Cohesion: 0.08
Nodes (43): _0(), bd(), Bh(), Bv(), c0, _d(), d0(), e0() (+35 more)
...
Cohesion: 0.28
Nodes (9): h(), C(), iw(), n(), Oc(), ow, r(), Ru() (+1 more)

### Community 59 - "Bundled JS (Misc 5)"
Cohesion: 0.11
Nodes (38): Bl(), ca(), Dn(), Du(), ee(), fc(), gr(), hc() (+30 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (58): Ac(), An(), ap(), bc(), bf(), cp(), ct(), cy() (+50 more)

### Community 83 - "Community 83"
Cohesion: 0.09
Nodes (38): at, ax(), cx(), dx(), em(), ex(), fx(), G1() (+30 more)

### Community 84 - "Community 84"
Cohesion: 0.10
Nodes (38): Cl(), Cu(), ed(), En(), eu(), fa(), Fg(), fu() (+30 more)

### Community 85 - "Community 85"
Cohesion: 0.15
Nodes (24): addObserver(), cancel(), clearGcTimeout(), clearTimeout(), destroy(), Eo(), getMutationCache(), hasListeners() (+16 more)

### Community 86 - "Community 86"
Cohesion: 0.13
Nodes (22): canRun(), continue(), execute(), fetch(), find(), is(), isFocused(), ja() (+14 more)

### Community 87 - "Community 87"
Cohesion: 0.20
Nodes (14): ad(), Af(), ai(), ch(), dh(), dt(), Er(), If() (+6 more)
...
Cohesion: 0.16
Nodes (19): bindMethods(), constructor(), createResult(), defaultMutationOptions(), Eo(), getCurrentResult(), getOptimisticResult(), getQueryCache() (+11 more)

### Community 95 - "Community 95"
Cohesion: 0.16
Nodes (16): _0(), ca(), Di(), ed(), ensureInfiniteQueryData(), fetchInfiniteQuery(), Gp(), ka() (+8 more)

### Community 97 - "Community 97"
Cohesion: 0.12
Nodes (18): av(), Dv(), fv(), getDefaultOptions(), isServer(), kd(), trackResult(), updateGcTime() (+10 more)

### Community 98 - "Community 98"
Cohesion: 0.18
Nodes (15): accent, closetId, data, findOwnedCloset(), name, request, router, season (+7 more)

### Community 99 - "Community 99"
Cohesion: 0.21
Nodes (10): requireAuth(), closeBrowser(), ensureBrowser(), fetchRenderedHtml(), launchBrowser(), app, port, server (+2 more)

### Community 100 - "Community 100"
Cohesion: 0.16
Nodes (15): as(), aw(), dw, gw(), Ha(), He, iw(), Jr (+7 more)

### Community 101 - "Community 101"
Cohesion: 0.18
Nodes (13): brand, closetId, ensureClosetAndSection(), findOwnedItem(), haystack, itemId, name, rawUrl (+5 more)

### Community 102 - "Community 102"
Cohesion: 0.19
Nodes (13): createResult(), gv(), la(), Ra(), rt(), sd(), shouldFetchOnReconnect(), shouldFetchOnWindowFocus() (+5 more)

### Community 103 - "Community 103"
Cohesion: 0.22
Nodes (10): email, name, password, router, safeUser, API Integration Tests, Schema and Migrations Tests, Test Database Helper (+2 more)
...
Cohesion: 0.33
Nodes (7): ParsedProduct, AuthenticatedUser, JwtClaims, Request, getJwtSecret(), signAuthToken(), verifyAuthToken()

### Community 106 - "Community 106"
Cohesion: 0.29
Nodes (8): getObserversCount(), isActive(), isDisabled(), isFetched(), isStale(), isStatic(), md(), qi()
...
Cohesion: 0.33
Nodes (6): cw(), Ff(), ko(), Nf(), ry(), vs()

### Community 111 - "Community 111"
Cohesion: 0.33
Nodes (6): onSubscribe(), setEventListener(), shouldFetchOnReconnect(), shouldFetchOnWindowFocus(), xd(), za()
...
Cohesion: 0.18
Nodes (11): _(), accessor(), am(), getUri(), h1(), he(), im(), m1() (+3 more)
...
Cohesion: 0.40
Nodes (5): bs(), Dm(), i(), Ya(), ys()

## Knowledge Gaps
- **278 isolated node(s):** `branches`, `tagFormat`, `plugins`, `CHROME_C`, `composite` (+273 more)
...
- **Why does `fetch()` connect `Bundled JS (Options)` to `Bundled JS (React Core)`, `Bundled JS (Task)`, `Bundled JS (Observer)`, `Browser Window UI`, `Product Parser Service`, `Bundled JS (DOM)`, `Community 85`, `Bundled JS (Misc 4)`, `Community 93`?**
  _High betweenness centrality (0.233) - this node is a cross-community bridge._
- **Why does `fetchRawHtml()` connect `Product Parser Service` to `Bundled JS (Options)`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `m()` connect `Community 85` to `Bundled JS (React Core)`, `Bundled JS (Task)`, `Bundled JS (Observer)`, `Bundled JS (Selector)`, `Community 111`, `Community 86`, `Bundled JS (Events)`, `Bundled JS (Options)`, `Bundled JS (Misc 4)`, `Community 93`, `Community 126`?**
