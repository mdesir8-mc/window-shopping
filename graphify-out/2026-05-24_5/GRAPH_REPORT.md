...
## Summary
- 1916 nodes · 4995 edges · 123 communities (88 shown, 35 thin omitted)
...
Cohesion: 0.07
Nodes (50): _0(), ai(), b0, Bh(), c0(), ch(), d0(), Df() (+42 more)

### Community 3 - "Bundled JS (Observer)"
Cohesion: 0.18
Nodes (12): addObserver(), canRun(), clearGcTimeout(), clearTimeout(), getMutationCache(), is(), ja(), mutate() (+4 more)

### Community 4 - "Bundled JS (Utilities)"
Cohesion: 0.12
Nodes (27): h(), An(), C(), eh(), En(), fa(), Fe(), Hf() (+19 more)
...
Cohesion: 0.15
Nodes (14): ClosetCard(), ClosetCardProps, ItemCard(), ItemGrid(), SidebarProps, formatRelativeDate(), hashTone(), parsePriceToNumber() (+6 more)

### Community 15 - "Bundled JS (DOM)"
Cohesion: 0.10
Nodes (23): add(), clear(), da(), Gc(), has(), i(), ir(), Jc() (+15 more)
...
Cohesion: 0.07
Nodes (55): Ag(), be(), bg(), Bl(), bo(), bu(), ca(), cd() (+47 more)

### Community 18 - "Bundled JS (Navigation)"
Cohesion: 0.20
Nodes (8): useCreateItem(), useParseUrl(), AddItemFlow(), Step, PLACEHOLDER_TONES, SEASONS, ModalProps, ProductTileProps

### Community 19 - "Bundled JS (Store)"
Cohesion: 0.10
Nodes (20): bd(), kh(), Qu(), ad(), Bf(), e(), el(), isServer() (+12 more)
...
Cohesion: 0.06
Nodes (61): ad(), Ae(), ai(), bg(), bo(), bu(), Cg(), ch() (+53 more)

### Community 23 - "Bundled JS (Misc)"
Cohesion: 0.19
Nodes (17): add(), Bt(), clear(), da(), has(), hh(), Hl(), is() (+9 more)

### Community 24 - "Bundled JS (Array Util)"
Cohesion: 0.31
Nodes (10): continue(), execute(), fetch(), find(), isFocused(), onFocus(), onOnline(), refetch() (+2 more)

### Community 25 - "Bundled JS (Options)"
Cohesion: 0.24
Nodes (13): build(), defaultQueryOptions(), fetchOptimistic(), get(), getQueryData(), getQueryDefaults(), getQueryState(), getSetCookie() (+5 more)
...
Cohesion: 0.07
Nodes (49): a0, Ac(), Ap(), ar(), bp(), Cg(), ct(), Di() (+41 more)
...
Cohesion: 0.06
Nodes (42): _(), _1(), a1(), accessor(), concat(), Cy(), dd(), defaultMutationOptions() (+34 more)
...
Cohesion: 0.06
Nodes (72): Wr(), aa(), Af(), ay(), bc(), Cl(), cp(), cr (+64 more)

### Community 36 - "Bundled JS (Selector)"
Cohesion: 0.06
Nodes (57): _(), accessor(), ah(), am(), B(), bindMethods(), bp(), bs() (+49 more)
...
Cohesion: 0.13
Nodes (15): Ep(), _f(), Ff(), getUri(), Go(), im(), jw, ko() (+7 more)

### Community 50 - "Bundled JS (Compat)"
Cohesion: 0.09
Nodes (39): _0(), b0(), Bh(), Bv(), c0, _d(), d0(), e0() (+31 more)
...
Cohesion: 0.07
Nodes (60): Af(), Bl(), ca(), Dc(), Di(), Dn(), Du(), ee() (+52 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (49): An(), ap(), bc(), bf(), cp(), ct(), cy(), ey() (+41 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (65): ax(), b1(), bx(), canRun(), continue(), cx(), delete(), dm() (+57 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (41): Cl(), Cu(), ed(), En(), Et(), eu(), fa(), Fg() (+33 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (59): addObserver(), av(), build(), cancel(), clearGcTimeout(), clearTimeout(), Cn(), defaultMutationOptions() (+51 more)
...
Cohesion: 0.18
Nodes (18): bindMethods(), constructor(), createResult(), Eo(), getCurrentResult(), getOptimisticResult(), getQueryCache(), gv() (+10 more)

### Community 95 - "Community 95"
Cohesion: 0.27
Nodes (10): Cn(), ensureInfiniteQueryData(), ensureQueryData(), fetchInfiniteQuery(), fetchQuery(), hm(), isStaleByTime(), kh() (+2 more)

### Community 97 - "Community 97"
Cohesion: 0.29
Nodes (7): kd(), av(), bv(), getDefaultOptions(), iv(), pv(), trackResult()
...
Cohesion: 0.33
Nodes (7): getObserversCount(), isActive(), isDisabled(), isStale(), isStatic(), md(), qi()
...
Cohesion: 0.29
Nodes (7): onSubscribe(), setEventListener(), shouldFetchOnReconnect(), shouldFetchOnWindowFocus(), xd(), yv(), za()

### Community 112 - "Community 112"
Cohesion: 0.22
Nodes (9): createResult(), gd(), isFetched(), Ra(), setData(), Ta(), th(), vd() (+1 more)
...
Cohesion: 0.22
Nodes (9): gd(), j1(), jh(), Ra(), setData(), sw, t1(), Ta() (+1 more)
...
Cohesion: 0.10
Nodes (26): at, cd(), d1(), ensureInfiniteQueryData(), f1(), fc(), fetchInfiniteQuery(), fp() (+18 more)
...
Cohesion: 0.40
Nodes (5): bs(), Dm(), Ya(), ys(), zm()

## Knowledge Gaps
- **279 isolated node(s):** `ItemFormModalProps`, `AppShellContextValue`, `AppShellContext`, `branches`, `tagFormat` (+274 more)
...
- **Why does `fetch()` connect `Bundled JS (Array Util)` to `Bundled JS (React Core)`, `Bundled JS (Observer)`, `Bundled JS (Utilities)`, `Browser Window UI`, `Product Parser Service`, `Bundled JS (DOM)`, `Community 115`, `Community 85`, `Bundled JS (Options)`, `Community 93`, `Community 95`?**
  _High betweenness centrality (0.249) - this node is a cross-community bridge._
- **Why does `fetchRawHtml()` connect `Product Parser Service` to `Bundled JS (Array Util)`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `m()` connect `Community 85` to `Bundled JS (React Core)`, `Bundled JS (Task)`, `Bundled JS (Utilities)`, `Bundled JS (Selector)`, `Community 111`, `Community 112`, `Community 115`, `Bundled JS (Store)`, `Community 83`, `Bundled JS (Array Util)`, `Community 93`?**
...
- **What connects `ItemFormModalProps`, `AppShellContextValue`, `AppShellContext` to the rest of the system?**
