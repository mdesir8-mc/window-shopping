...
## Corpus Check
- 88 files · ~41,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1919 nodes · 4997 edges · 129 communities (90 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 123 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1350a602`
...
Cohesion: 0.06
Nodes (59): b0, bc(), Bh(), c0(), cr, d0(), dc(), Du() (+51 more)
...
Cohesion: 0.09
Nodes (44): at, ax(), b1(), bx(), Ce(), cx(), dx(), ei() (+36 more)
...
Cohesion: 0.07
Nodes (27): add(), bs(), clear(), da(), Dm(), Gc(), has(), i() (+19 more)
...
Cohesion: 0.06
Nodes (68): ad(), Ag(), ah(), ai(), An(), bg(), Bl(), bu() (+60 more)
...
Cohesion: 0.17
Nodes (13): bd(), bf(), Et(), $f(), Hp(), If(), kh(), Qc() (+5 more)
...
Cohesion: 0.07
Nodes (59): ad(), Ae(), ai(), bg(), bo(), bu(), Cg(), ch() (+51 more)

### Community 23 - "Bundled JS (Misc)"
Cohesion: 0.08
Nodes (39): add(), Bt(), cd(), clear(), da(), ensureInfiniteQueryData(), Gl(), Gp() (+31 more)

### Community 24 - "Bundled JS (Array Util)"
Cohesion: 0.17
Nodes (13): b1(), delete(), fd(), H1(), Hg(), jy(), mi(), rl() (+5 more)

### Community 25 - "Bundled JS (Options)"
Cohesion: 0.07
Nodes (47): kd(), av(), build(), bv(), canRun(), Cn(), continue(), defaultQueryOptions() (+39 more)
...
Cohesion: 0.11
Nodes (30): _0(), be(), bo(), ca(), ed(), ensureInfiniteQueryData(), eu(), fetchInfiniteQuery() (+22 more)

### Community 30 - "Bundled JS (Events)"
Cohesion: 0.06
Nodes (49): Ac(), Ap(), ar(), ay(), Bf(), bp(), Cg(), ct() (+41 more)
...
Cohesion: 0.07
Nodes (34): _(), a0, a1(), accessor(), am(), concat(), defaultMutationOptions(), Fl() (+26 more)
...
Cohesion: 0.08
Nodes (48): Wr(), aa(), Af(), Cl(), cp(), Cu(), Dn(), eh() (+40 more)

### Community 36 - "Bundled JS (Selector)"
Cohesion: 0.05
Nodes (60): _(), accessor(), ah(), am(), B(), b0(), bindMethods(), bp() (+52 more)
...
Cohesion: 0.09
Nodes (41): _0(), Bh(), Bv(), c0, _d(), d0(), e0(), f0() (+33 more)
...
Cohesion: 0.17
Nodes (13): Dc(), Dn(), gr(), h0(), je(), $l(), Ll(), ny() (+5 more)

### Community 59 - "Bundled JS (Misc 5)"
Cohesion: 0.10
Nodes (40): Af(), Bl(), ca(), Du(), ee(), fc(), fp(), gh() (+32 more)

### Community 82 - "Community 82"
Cohesion: 0.16
Nodes (19): ap(), bc(), cp(), Fi(), Fo(), io(), ip(), Mf() (+11 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (43): ax(), bx(), canRun(), continue(), cx(), dm(), dx(), em() (+35 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (56): Cl(), createResult(), Cu(), Di(), ed(), En(), eu(), fa() (+48 more)

### Community 85 - "Community 85"
Cohesion: 0.14
Nodes (15): av(), Dv(), fv(), getCurrentResult(), getDefaultOptions(), getOptimisticResult(), getQueryCache(), Jd() (+7 more)
...
Cohesion: 0.07
Nodes (55): invalidate(), onMutationUpdate(), addObserver(), bindMethods(), C(), cancel(), clearGcTimeout(), clearTimeout() (+47 more)

### Community 95 - "Community 95"
Cohesion: 0.17
Nodes (12): _1(), Cy(), delete(), Et(), Lg(), mg(), mh(), u1() (+4 more)

### Community 97 - "Community 97"
Cohesion: 0.24
Nodes (11): defaultMutationOptions(), Eo(), getMutationDefaults(), hasListeners(), isServer(), onQueryUpdate(), reset(), setOptions() (+3 more)
...
Cohesion: 0.32
Nodes (8): An(), ct(), Hf(), np(), Ou(), sl(), Tp(), Xl()

### Community 111 - "Community 111"
Cohesion: 0.36
Nodes (8): Cn(), ensureQueryData(), fetchInfiniteQuery(), fetchQuery(), isStaleByTime(), jh(), prefetchInfiniteQuery(), prefetchQuery()

### Community 112 - "Community 112"
Cohesion: 0.40
Nodes (5): gd(), Ra(), Ta(), th(), vd()
...
Cohesion: 0.29
Nodes (8): dd(), ey(), ky(), mi(), nm(), rl(), uu(), xf()

### Community 120 - "Community 120"
Cohesion: 0.33
Nodes (6): at, d1(), f1(), hx, jo(), wx()

### Community 122 - "Community 122"
Cohesion: 0.50
Nodes (5): cy(), gc(), Qf(), sr(), Wf()

### Community 123 - "Community 123"
Cohesion: 0.50
Nodes (4): rv(), setTimeout(), w1(), yg()

### Community 129 - "Community 129"
Cohesion: 0.29
Nodes (7): mount(), Ms(), onSubscribe(), setEventListener(), subscribe(), toAbortSignal(), unmount()

## Knowledge Gaps
- **281 isolated node(s):** `CHROME_C`, `composite`, `target`, `lib`, `module` (+276 more)
...
- **Why does `fetch()` connect `Bundled JS (Options)` to `Bundled JS (React Core)`, `Browser Window UI`, `Product Parser Service`, `Bundled JS (DOM)`, `Community 93`?**
  _High betweenness centrality (0.249) - this node is a cross-community bridge._
- **Why does `fetchRawHtml()` connect `Product Parser Service` to `Bundled JS (Options)`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `m()` connect `Community 93` to `Bundled JS (React Core)`, `Bundled JS (Task)`, `Community 129`, `Bundled JS (Observer)`, `Bundled JS (Selector)`, `Community 97`, `Community 83`, `Bundled JS (Options)`?**
