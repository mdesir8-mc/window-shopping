...
- Only commit/push regenerated `graphify-out/` changes on `feat:` and higher (`feat:`, `feat!:`). For `fix:`, `chore:`, `docs:`, `refactor:`, and `test:`, leave `graphify-out/` out of the commit even after running `graphify update .` (keep the working-tree refresh local).
