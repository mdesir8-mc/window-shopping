...
// apiClient) so we never attach the viewer's bearer token / cookies and never trip
// the 401→/login redirect interceptor — a bad/revoked token returns a plain 404.
